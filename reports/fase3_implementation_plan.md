...
Il controllo che discrimina è la **densità nucleare**, che a 0.46 µm/px diventa 14.505/mm² (letteratura: 10.000–20.000/mm² per tessuto linfoide; a 0.23 µm/px sarebbe 58.019/mm², impossibile). Il diametro nucleare corretto per la sotto-copertura del Watershed è coerente ma meno stringente: con il Dice definitivo di 0.795 risulta ~5.6 µm, appena sotto l'intervallo 6–12 µm atteso per un linfocita. La correzione 1/sqrt(Dice) è del resto approssimativa — il Dice non è la frazione di area coperta e la segmentazione produce anche falsi positivi — quindi non va usata come verifica indipendente sullo stesso piano della densità.
